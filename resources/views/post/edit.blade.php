        ...
        <form action={{ route('posts.update', $post->id) }} method="POST"
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" placeholder="Add job description"
                    class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ $post->description }}</textarea>
            </div>

            <!-- Price -->
            <div>
                <label for="price" class="block text-sm font-medium text-gray-700">Price</label>
                <input type="number" name="price" id="price" placeholder="Add price" value="{{ $post->price }}"
                    class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
            </div>
            ...
            <div>
                ...
                <input type="text" name="timeline" id="timeline" placeholder="E.g. 5 days" value="{{ $post->timeline }}"
                    class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
            </div>
